  ...
  return (
    <>
      <div>
        ...
        <section className="col-md-12  px-md-5 featured-top11 ">
                          ...
                          <div class="container">
                            <div class="align-items-start row">
                              <div class="col-6 text-left">
                                <div className='rdOnlyLabel'>Mobile</div>
                                    <div className='rdOnlyValue'>{userDataN.mobile}</div></div>
                                   <div class="col-6 text-left">
                                  <div className='rdOnlyLabel'>Email</div>
                                    <div className='rdOnlyValue'>{userDataN.email}</div>
                                    </div>
                                     <div class="col-6 text-left">
                                      <div className='rdOnlyLabel'>Email</div>
                                    <div className='rdOnlyValue'>{userDataN.email}</div></div>
                                     <div class="col-6 text-left"><div className='rdOnlyLabel'>Mobile</div>
                                    <div className='rdOnlyValue'>{userDataN.mobile}</div>
                                    </div>
                                     <div class="col-6 text-left">
                                      <div className='rdOnlyLabel'>Country</div>
                                    <div className='rdOnlyValue'>{userDataN.country}</div>
                                     </div><div class="col-6 text-left">
                                      <div className='rdOnlyLabel'>Member Since</div>
