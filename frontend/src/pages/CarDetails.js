              ...
              <div className="col-md-12	featured-top">
                <div className="row no-gutters">
                  ...
                  <div className="col-md-6 d-flex align-items-start">
                    ...
                    <form action="#" className="request-form fadeInUp text-left w-100 cardetailsForm">
                      <h2>Vehicle Details</h2>

                      <div className="d-flex">
                        <div className="form-group">
                          <label className="labelWhiteText">Car Brand</label>
                          <label className="valueNormalTxt">{backendData.brand + " " + backendData.name}</label>
                        </div>
                      ...
                      <div className="d-flex">
                        <div className="form-group mr-2">
                          ...
                          <label className="valueNormalTxt setenceCase">{backendData.vehicletype}</label>
                        </div>
                        <div className="form-group ml-2">
                          <label className="labelWhiteText">Fuel Type</label>
                          <label className="valueNormalTxt setenceCase">{backendData.fueltype}</label>
                        </div>
                      </div>
                      ...
                      <div className="d-flex">
                        <div className="form-group ml-2">
                          ...
                          <label className="valueNormalTxt setenceCase">
                            <input
                              type="text"
