...
const CarList = ({ backendData}) => {
  ...
  return (
    ...
    <div className='carListSection'>
      <section className="ftco-section ftco-no-pt bg-light1 mx-md-4">
        <div className="container-fluid">
          {/* <h2>Car List</h2> */}
          <div className="row carListRow">
          ...
          <div ref={filterRef} className={ showFilter ? 'row showWindowFilter carListRowTop' : 'd-none'}>
          ...
          <div className="row mt-3">
            {filteredCars.map((car, index) => (
              <div key={index} className="col-md-4">
                {car && car.popular && (
                  <div className="ribbon down" style={{ "--color": "#f77d08" }}>
                ...
                <div className="col-lg-12 col-md-12 mb-2">
                    <div class="rent-item col-lg-12 col-md-12 mb-4">
                      <div class="text-center imgMinHt">
                     <img
    className="img-fluid col-lg-12 col-md-12 mb-4"
    src={`/resources/images/cars/${car.carid}.png`}
    alt=""
  /></div>
                     <h4 class="text-uppercase mb-4"><a href="#">{car.brand} {car.name}</a></h4>

                     <div class="d-flex justify-content-center col-lg-12 col-md-12 mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>{car.vehicletype}</span>
                            </div>
                            <div class="px-2 border-left border-right">
                                <i class="fa fa-map text-primary mr-1"></i>
                                <span>{car.locations}</span>
                            </div>
                            <div class="px-2">
                         ...
                         <Link to={`/cardetails/${car.carid}`} class="btn btn-primary px-3">Book Now</Link>
